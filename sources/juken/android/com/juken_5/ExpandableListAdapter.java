...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = ((LayoutInflater) this.mContext.getSystemService("layout_inflater")).inflate(R.layout.listheader, (ViewGroup) null);
        }
        ...
        if (ind != null) {
            ...
            if (getChildrenCount(groupPosition) == 0) {
                ...
                indicator.getDrawable().setState(GROUP_STATE_SETS[isExpanded ? 1 : 0]);
            }
        }
        return convertView;
    }
