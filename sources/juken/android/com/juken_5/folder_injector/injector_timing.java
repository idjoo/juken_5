...
public class injector_timing extends AppCompatActivity {
    ...
    final CharSequence[] items = {"IT Core 1", "IT Core 2"};
    int jumlah = 0;
    int keadaan = 0;
    ...
    public Handler mHandler = new Handler(Looper.getMainLooper()) {
        public void handleMessage(Message message) {
            Toast.makeText(injector_timing.this.getApplicationContext(), (String) message.obj, 1).show();
        }
    };
    int maksimum = 0;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.injector_timing);
        ...
        text.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                injector_timing.this.save_data_ke_list();
                if (StaticClass.TipeKoneksi.equals("bt")) {
                    injector_timing.this.resetConnection();
                }
                injector_timing.this.finish();
                Intent i1 = new Intent(view.getContext(), imp_injector.class);
                i1.putExtra("posisi", textView.getText().toString());
                injector_timing.this.startActivityForResult(i1, 0);
            }
        });
        ...
        while (this.value <= 1281) {
            ...
            berhasil.addTextChangedListener(new TextWatcher() {
                public void beforeTextChanged(CharSequence charSequence, int i, int i1, int i2) {
                    injector_timing.this.compare = berhasil.getText().toString();
                }
                ...
                public void afterTextChanged(Editable editable) {
                    if (!injector_timing.this.compare.equals(editable.toString())) {
                        StaticClass.saveIT = true;
                    }
                }
            });
            this.value++;
        ...
        ((ImageButton) findViewById(R.id.send_map_f)).setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                injector_timing.this.core_dipilih = 0;
                AlertDialog.Builder builder = new AlertDialog.Builder(injector_timing.this);
                builder.setTitle((CharSequence) "Send Map");
                builder.setSingleChoiceItems(injector_timing.this.items, 0, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int item) {
                        injector_timing.this.core_dipilih = item;
                    }
                });
                builder.setPositiveButton((CharSequence) "Ok", (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        AlertDialog.Builder alert = new AlertDialog.Builder(injector_timing.this);
                        alert.setTitle((CharSequence) "Alert");
                        alert.setMessage((CharSequence) injector_timing.this.getString(R.string.TanyaSendAllMap));
                        alert.setPositiveButton((CharSequence) "Yes", (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int whichButton) {
                                injector_timing.this.sendMapFuel = true;
                                if (injector_timing.this.Koneksi.booleanValue()) {
                                    injector_timing.this.keadaan = 0;
                                    if (injector_timing.this.hitung_tps > 0) {
                                        injector_timing.this.hitung_tps = 0;
                                    }
                                    if (injector_timing.this.core_dipilih == 0) {
                                        MappingHandle.NamaFileIT = "Injector Timing - ECU Core 1";
                                        injector_timing.this.toolbar.setTitle((CharSequence) MappingHandle.NamaFileIT);
                                        injector_timing.this.posisi_memory = injector_timing.this.sharedPreferences.getString("it_c1", "it_c11");
                                    } else {
                                        MappingHandle.NamaFileIT = "Injector Timing - ECU Core 2";
                                        injector_timing.this.toolbar.setTitle((CharSequence) MappingHandle.NamaFileIT);
                                        injector_timing.this.posisi_memory = injector_timing.this.sharedPreferences.getString("it_c2", "it_c21");
                                    }
                                    injector_timing.this.kirim(injector_timing.this.posisi_memory);
                                }
                            }
                        });
                        alert.setNegativeButton((CharSequence) "No", (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialogInterface, int i) {
                                injector_timing.this.sendMapFuel = false;
                                if (injector_timing.this.Koneksi.booleanValue()) {
                                    injector_timing.this.keadaan = 0;
                                    if (injector_timing.this.hitung_tps > 0) {
                                        injector_timing.this.hitung_tps = 0;
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton((CharSequence) "Ok", (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        AlertDialog.Builder alert = new AlertDialog.Builder(injector_timing.this);
                        alert.setTitle((CharSequence) "Alert");
                        alert.setMessage((CharSequence) injector_timing.this.getString(R.string.TanyaAllMap));
                        alert.setPositiveButton((CharSequence) "Yes", (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int whichButton) {
                                ...
                                if (injector_timing.this.Koneksi.booleanValue()) {
                                    ...
                                    if (injector_timing.this.tps_terima > 0) {
                                        injector_timing.this.tps_terima = 0;
                                    }
                                    if (injector_timing.this.core_dipilih == 0) {
                                        MappingHandle.NamaFileIT = "Injector Timing - ECU Core 1";
                                        injector_timing.this.toolbar.setTitle((CharSequence) MappingHandle.NamaFileIT);
                                    ...
                                    injector_timing.this.terima(injector_timing.this.posisi_memory);
                                }
                            }
                        });
                        alert.setNegativeButton((CharSequence) "No", (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
        ...
        ((ImageButton) findViewById(R.id.open_map_f)).setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                try {
                    ...
                    injector_timing.this.finish();
                    injector_timing.this.startActivityForResult(new Intent(injector_timing.this, ImportData.class), 100);
                } catch (Exception x) {
        ...
        ((ImageButton) findViewById(R.id.save_map_f)).setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                AlertDialog.Builder alert1 = new AlertDialog.Builder(injector_timing.this);
                alert1.setTitle((CharSequence) "Save File");
                alert1.setMessage((CharSequence) "Enter Your File Name Here");
                final EditText input = new EditText(injector_timing.this);
                ...
                alert1.setPositiveButton((CharSequence) "SAVE", (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        injector_timing.this.save_data_ke_list();
                        injector_timing.this.srt = input.getEditableText().toString();
                        injector_timing.this.writeToFile(injector_timing.this.srt);
                    }
                });
        ...
        ((ImageButton) findViewById(R.id.afr)).setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                injector_timing.this.SavePreferences("back_pressed_mapping", "2");
                injector_timing.this.save_data_ke_list();
                injector_timing.this.finish();
                injector_timing.this.startActivityForResult(new Intent(v.getContext(), afr_display.class), 0);
            }
        });
        final ImageButton his_afr = (ImageButton) findViewById(R.id.his_afr);
        his_afr.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if (injector_timing.this.kondisi_history.booleanValue()) {
                    injector_timing.this.kondisi_history = false;
                    if (Build.VERSION.SDK_INT >= 21) {
                        his_afr.setImageDrawable(injector_timing.this.getResources().getDrawable(R.drawable.his_afr, injector_timing.this.getApplicationContext().getTheme()));
                    } else {
                        his_afr.setImageDrawable(injector_timing.this.getResources().getDrawable(R.drawable.his_afr));
                    }
                    int i = 1;
                    while (i <= 1281) {
                        EditText edit = (EditText) injector_timing.this.findViewById(i);
                        try {
                ...
                injector_timing.this.kondisi_history = true;
                if (Build.VERSION.SDK_INT >= 21) {
                    his_afr.setImageDrawable(injector_timing.this.getResources().getDrawable(R.drawable.his_history, injector_timing.this.getApplicationContext().getTheme()));
                } else {
                    his_afr.setImageDrawable(injector_timing.this.getResources().getDrawable(R.drawable.his_history));
                }
                for (int i2 = 1; i2 <= 1281; i2++) {
                    EditText edit2 = (EditText) injector_timing.this.findViewById(i2);
                    try {
        ...
        ((ImageButton) findViewById(R.id.interpolation)).setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                injector_timing.this.interpolasi();
            }
        });
        this.toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(this.toolbar);
        getSupportActionBar().setDisplayShowTitleEnabled(false);
        this.toolbar.setTitle((CharSequence) MappingHandle.NamaFileIT);
    }
    ...
    private void getNilai() {
        cek_nilai();
        if (MappingHandle.list_injector.size() < 2) {
        ...
        for (int i2 = 1; i2 <= 1281; i2++) {
            ...
            try {
                v2.setText(String.valueOf(MappingHandle.list_injector.get(i2 - 1)));
        ...
        int posisiIT = 1;
        for (int i3 = 1; i3 <= MappingHandle.list_injector_ganti.size(); i3++) {
            EditText views = (EditText) findViewById(posisiIT);
            if (posisiIT > 1260) {
                posisiIT -= 1259;
                if (posisiIT == 22) {
                    posisiIT = 1;
            ...
            if (MappingHandle.list_injector_ganti.get(i3 - 1).equals("1")) {
    ...
    private void cek_nilai() {
        if (MappingHandle.list_injector.size() < 2) {
            for (int i = 0; i < 1281; i++) {
                if (i / 61 == 0) {
                    MappingHandle.list_injector.add("168");
                } else {
                    MappingHandle.list_injector.add("250");
                }
            }
        }
    ...
    public void save_data_ke_list() {
        MappingHandle.list_injector.clear();
        for (int i = 1; i <= 1281; i++) {
            MappingHandle.list_injector.add(((EditText) findViewById(i)).getText().toString());
        }
    }
    ...
    private void LoadPreferences() {
        if (StaticClass.TipeKoneksi.equals("bt") && this.bluetooth.isEnabled()) {
            ...
            new Thread() {
                public void run() {
                    injector_timing.this.connect(perangkat);
                }
            }.start();
        }
    }
                        ...
                        if (this.cek == 0) {
                            if (b == 10 || b == 59) {
                                ...
                                this._handler.post(new Runnable() {
                                    public void run() {
                                        if (injector_timing.this.data.equals("1A00")) {
                                            if (injector_timing.this.hitung_tps < 21) {
                                                injector_timing.this.kirim(injector_timing.this.posisi_memory);
                                            } else if (injector_timing.this.sendMapFuel.booleanValue()) {
                                                Message message23 = Message.obtain();
                                                message23.obj = "Send Fuel Correction";
                                                message23.setTarget(injector_timing.this.mHandler);
                                                ...
                                                injector_timing.this.hitung_tps = 0;
                                                injector_timing.this.kirimFuelCorrection(injector_timing.this.posisi_memory);
                                            } else {
                                                StaticClass.saveIT = false;
                                                Message message232 = Message.obtain();
                                                message232.obj = "Send Done";
                                                message232.setTarget(injector_timing.this.mHandler);
                                                message232.sendToTarget();
                                                injector_timing.this.progressDialog.dismiss();
                                            }
                                        } else if (injector_timing.this.keadaan < 2) {
                                            Message message233 = Message.obtain();
                                            message233.obj = "failed to send";
                                            message233.setTarget(injector_timing.this.mHandler);
                                            message233.sendToTarget();
                                            injector_timing.this.keadaan++;
                                        }
                                    }
                                });
                            } else {
                            ...
                            if (b == 59 || b == 10) {
                                ...
                                this._handler.post(new Runnable() {
                                    public void run() {
                                        if (!data2.equals("9603") && !data2.equals("\r") && !data2.equals("\n") && !data2.equals("1A00") && !data2.equals("1a00")) {
                                            EditText edit = (EditText) injector_timing.this.findViewById(injector_timing.this.alamat);
                                            edit.setText(data2.trim());
                                            MappingHandle.list_injector.add(data2.trim());
                                            if (injector_timing.this.mod(injector_timing.this.alamat, 61) == 0) {
                                                edit.setText(data2.replaceAll("\\r", ""));
                                                if (injector_timing.this.tps_terima < 21) {
                                                    injector_timing.this.terima(injector_timing.this.posisi_memory);
                                                } else if (injector_timing.this.sendMapFuel.booleanValue()) {
                                                    if (injector_timing.this.core_dipilih == 0) {
                                                        MappingHandle.NamaFileFuel = "Fuel Correction - ECU Core 1";
                                                    ...
                                                    message23.sendToTarget();
                                                    injector_timing.this.tps_terima = 0;
                                                    injector_timing.this.alamat = 0;
                                                    MappingHandle.list_fuel.clear();
                                                    injector_timing.this.terimaFuel(injector_timing.this.posisi_memory);
                                                } else {
                                                    StaticClass.saveIT = false;
                                                    Message message232 = Message.obtain();
                                            ...
                                            injector_timing.this.alamat++;
                                            if (injector_timing.this.alamat > 1281) {
                                                injector_timing.this.alamat = 1;
                                            }
                                        }
                                    }
                                });
                                ...
                                this._handler.post(new Runnable() {
                                    public void run() {
                                        if (injector_timing.this.data.equals("1A00")) {
                                            ...
                                            injector_timing.this.hitung_tps = 0;
                                            injector_timing.this.kirimBaseMap(injector_timing.this.posisi_memory);
                                        } else if (injector_timing.this.keadaan < 2) {
                                            Message message232 = Message.obtain();
                                ...
                                this._handler.post(new Runnable() {
                                    public void run() {
                                        if (injector_timing.this.data.equals("1A00")) {
                                            ...
                                            injector_timing.this.hitung_tps = 0;
                                            injector_timing.this.kirimIgnitionTiming(injector_timing.this.posisi_memory);
                                        } else if (injector_timing.this.keadaan < 2) {
                                            Message message232 = Message.obtain();
                                            message232.obj = "failed to send";
                                            message232.setTarget(injector_timing.this.mHandler);
                                        ...
                                        if (!data3.equals("9602") && !data3.equals("\r")) {
                                            ...
                                            if (injector_timing.this.mod(injector_timing.this.alamat, 61) == 0) {
                                                if (injector_timing.this.tps_terima < 21) {
                                                    ...
                                                    injector_timing.this.terimaBaseMap(injector_timing.this.posisi_memory);
                                                }
                                            }
                                            injector_timing.this.alamat++;
                                            if (injector_timing.this.alamat > 1281) {
                                        ...
                                        if (!data4.equals("9601") && !data4.equals("\r")) {
                                            ...
                                            if (injector_timing.this.mod(injector_timing.this.alamat, 61) == 0) {
                                                if (injector_timing.this.tps_terima < 21) {
                                                    ...
                                                    injector_timing.this.CurrentPatternFile();
                                                    if (injector_timing.this.core_dipilih == 0) {
                                                        MappingHandle.NamaFileIG = "Ignition Timing - ECU Core 1";
                                                    } else {
                                                        MappingHandle.NamaFileIG = "Ignition Timing - ECU Core 2";
                                                    ...
                                                    injector_timing.this.tps_terima = 0;
                                                    injector_timing.this.alamat = 0;
                                                    injector_timing.this.terimaIgnitionTiming(injector_timing.this.posisi_memory);
                                                }
                                            }
                                            injector_timing.this.alamat++;
                                            if (injector_timing.this.alamat > 1281) {
                                ...
                                this._handler.post(new Runnable() {
                                    public void run() {
                                        if (!data5.equals("9605") && !data5.equals("\r")) {
                                            ...
                                            if (injector_timing.this.mod(injector_timing.this.alamat, 31) == 0) {
                                                if (injector_timing.this.tps_terima < 21) {
                                                    injector_timing.this.terimaIgnitionTiming(injector_timing.this.posisi_memory);
                                                } else {
                                                    StaticClass.saveFuel = false;
                                            ...
                                            injector_timing.this.alamat++;
                                            if (injector_timing.this.alamat > 651) {
                                                injector_timing.this.alamat = 1;
                                            }
                                        }
                                    }
    ...
    public void terima(String posisi) {
        ...
        if (this.tps_terima == 0) {
            runOnUiThread(new Runnable() {
                public void run() {
                    injector_timing.this.progressDialog = new ProgressDialog(injector_timing.this);
                    injector_timing.this.progressDialog.setMessage("Loading...");
                    injector_timing.this.progressDialog.setTitle("Get Map");
                    injector_timing.this.progressDialog.setProgressStyle(0);
                    injector_timing.this.progressDialog.show();
                    injector_timing.this.progressDialog.setCancelable(true);
                }
            });
            if (this.sendMapFuel.booleanValue()) {
                Toast.makeText(getApplicationContext(), "Get Injector Timing", 0).show();
            } else {
        ...
        if (this.hitung_tps == 0) {
            runOnUiThread(new Runnable() {
                public void run() {
                    injector_timing.this.progressDialog = new ProgressDialog(injector_timing.this);
                    injector_timing.this.progressDialog.setMessage("Loading...");
                    injector_timing.this.progressDialog.setTitle("Send Map");
                    injector_timing.this.progressDialog.setProgressStyle(0);
                    injector_timing.this.progressDialog.show();
                    injector_timing.this.progressDialog.setCancelable(true);
                }
            ...
            if (this.sendMapFuel.booleanValue()) {
                Toast.makeText(getApplicationContext(), "Send Injector Timing", 0).show();
            } else {
    ...
    public void add_value() {
        ...
        alert.setPositiveButton((CharSequence) "OK", (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int whichButton) {
                injector_timing.this.AddValue(inputNilaiAdd.getEditableText().toString());
            }
        });
    ...
    public void set_value() {
        ...
        alert_set.setPositiveButton((CharSequence) "OK", (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int whichButton) {
                injector_timing.this.SetValue(inputNilai.getEditableText().toString());
            }
        });
    ...
    public class SaveDataExt extends AsyncTask<Void, Void, Void> {
        ...
        public void onPreExecute() {
            this.progressDialog = ProgressDialog.show(injector_timing.this, "Program loading", "Please wait..", true);
        }
    ...
    class MyBroadCastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(android.content.Context r13, android.content.Intent r14) {
            ...
            L_0x004a:
                ...
                goto L_0x0015
            L_0x0054:
                juken.android.com.juken_5.folder_injector.injector_timing r6 = juken.android.com.juken_5.folder_injector.injector_timing.this     // Catch:{ Exception -> 0x006a }
                ...
                juken.android.com.juken_5.folder_injector.injector_timing r6 = juken.android.com.juken_5.folder_injector.injector_timing.this     // Catch:{ Exception -> 0x006a }
                juken.android.com.juken_5.folder_injector.injector_timing r7 = juken.android.com.juken_5.folder_injector.injector_timing.this     // Catch:{ Exception -> 0x006a }
            ...
            L_0x038b:
                ...
                goto L_0x0374
            L_0x03b6:
                juken.android.com.juken_5.folder_injector.injector_timing r6 = juken.android.com.juken_5.folder_injector.injector_timing.this     // Catch:{ IllegalArgumentException -> 0x03d0 }
                juken.android.com.juken_5.folder_injector.injector_timing r7 = juken.android.com.juken_5.folder_injector.injector_timing.this     // Catch:{ IllegalArgumentException -> 0x03d0 }
                juken.android.com.juken_5.folder_injector.injector_timing$MyBroadCastReceiver r7 = r7.myBroadCastReceiver     // Catch:{ IllegalArgumentException -> 0x03d0 }
                r6.unregisterReceiver(r7)     // Catch:{ IllegalArgumentException -> 0x03d0 }
            L_0x03bf:
                java.util.ArrayList<java.lang.Integer> r6 = juken.android.com.juken_5.folder_injector.StaticClass.position     // Catch:{ Exception -> 0x006a }
                r6.clear()     // Catch:{ Exception -> 0x006a }
                juken.android.com.juken_5.folder_injector.injector_timing r6 = juken.android.com.juken_5.folder_injector.injector_timing.this     // Catch:{ Exception -> 0x006a }
            ...
            L_0x03d0:
                ...
                goto L_0x03bf
            */
            throw new UnsupportedOperationException("Method not decompiled: juken.android.com.juken_5.folder_injector.injector_timing.MyBroadCastReceiver.onReceive(android.content.Context, android.content.Intent):void");
        }
    }
