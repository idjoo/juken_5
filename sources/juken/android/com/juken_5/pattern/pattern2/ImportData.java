...
import juken.android.com.juken_5.folder_base_map.FileArrayAdapter;
import juken.android.com.juken_5.folder_base_map.Option;
...
public class ImportData extends ListActivity {
    ...
    private void onFileClick(Option o) {
        if (o.getName().substring(o.getName().length() - 3).equals("Ptn")) {
            ...
            finish();
            startActivityForResult(new Intent(this, pattern2.class), 100);
            return;
        }
