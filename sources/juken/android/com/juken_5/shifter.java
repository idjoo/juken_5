...
public class shifter extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.shifter);
        if (StaticClass.TipeKoneksi.equals("wifi")) {
            this.myBroadCastReceiver = new MyBroadCastReceiver();
            registerMyReceiver();
            this.service = new Intent(this, WifiService.class);
        }
        this.nilai_shifter = (EditText) findViewById(R.id.et_shifter);
        this.nilai_shifter.setFilters(new InputFilter[]{new range_int1(1, (int) ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION)});
        ((Button) findViewById(R.id.exit_shifter)).setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                shifter.this.finish();
            }
        });
        this.save = (Button) findViewById(R.id.save_shifter);
    ...
    private void LoadPreferences() {
        ...
        String nilai = sharedPreferences.getString("shift", "shift1");
        this.nilai_shifter = (EditText) findViewById(R.id.et_shifter);
        this.nilai_shifter.setText(nilai);
        if (StaticClass.TipeKoneksi.equals("bt") && this.bluetooth.isEnabled()) {
            ...
            new Thread() {
                public void run() {
                    shifter.this.connect(perangkat);
                }
            }.start();
        }
    }
    ...
    public void kirim() {
        String code = this.nilai_shifter.getText().toString();
        String code1 = "3614" + ";" + code + "\r\n";
        byte[] msgBuffer = code1.getBytes();
        SavePreferences("shift", code);
        if (StaticClass.TipeKoneksi.equals("wifi")) {
                            ...
                            this._handler.post(new Runnable() {
                                public void run() {
                                    if (data.replaceAll("\\n", "").replaceAll("\\r", "").equals("1A00")) {
                                        Toast.makeText(shifter.this.getApplicationContext(), "data saved", 0).show();
                                    } else {
                                        Toast.makeText(shifter.this.getApplicationContext(), "failed to send", 0).show();
                                    }
                                }
                            });
                        } else {
    ...
    class MyBroadCastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(android.content.Context r6, android.content.Intent r7) {
            ...
            L_0x0032:
                ...
                goto L_0x0013
            L_0x0037:
                juken.android.com.juken_5.shifter r2 = juken.android.com.juken_5.shifter.this     // Catch:{ Exception -> 0x0032 }
                r2.finish()     // Catch:{ Exception -> 0x0032 }
                goto L_0x0013
            */
            throw new UnsupportedOperationException("Method not decompiled: juken.android.com.juken_5.shifter.MyBroadCastReceiver.onReceive(android.content.Context, android.content.Intent):void");
        }
    }
